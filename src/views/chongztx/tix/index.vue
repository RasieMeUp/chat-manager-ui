<template>
  <a-card :bordered="false">
    ...
    <div class="ul-list" >
      <span>提现人数：<em>{{totalCount}}</em>人</span>
      <span>提现总额：<em>{{totolRecharge/100}}</em>元</span>
    </div>
    <s-table
      ref="table"
      size="default"
    ...
    >
      ...
      <span slot="drawCurr" slot-scope="drawCurr">
        <template>
          {{ drawCurr | isEmpty(false) }}
        </template>
      </span>
...
import { getWithdrawList ,getBrandList} from "@/api/system/withdrawManager";
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          dataIndex: "drawCurr",
           width:"120px",
           scopedSlots: { customRender: "drawCurr" },
        },
        {
          title: "提现前余额（聊币）",
