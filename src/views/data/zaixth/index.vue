<template>
  <a-card :bordered="false">
      ...
      <a-form layout="inline">
        <a-row :gutter="48">
         <a-col :md="4" :sm="10">
          ...
          <a-col :md="4" :sm="10">
            <a-form-item>
              <a-range-picker @change="rangeOnChange" :value="rangeValue" parameter="自定义日期（时间段）"  :disabled-date="disabledPriceRangeDate"  />
            </a-form-item>
          </a-col>
           <a-col :md="4" :sm="10">
          ...
          <a-col :md="6" :sm="10">
            <a-form-item label="时长范围">
              <a-input v-model="queryParam.acceptDigitId" style="width:100px;" placeholder /> 分钟 至 <a-input v-model="queryParam.acceptDigitId"  style="width:100px;" placeholder /> 分钟
            </a-form-item>
          </a-col>
    ...
    <div class="ul-list">
        <span>拨打人数：<em>无字段……</em></span>
        <span>拨打次数：<em>无字段……</em></span>
        <span>接通人数：<em>无字段……</em></span>
        <span>接通次数：<em>无字段……</em></span>
        <span>通话总时长：<em>{{ duration | secondToDate(false) }}</em></span>
        <span>平均通话时长：<em>{{ duration | secondToDate(false) }}</em></span>
    </div>
    <s-table
      ref="table"
      size="default"
