<template>
  <a-card :bordered="false">
    ...
    <div class="ul-list">
        <span>活跃用户：<em>无字段……</em>人</span>
        <span>新注册用户：<em>无字段……</em>人</span>
        <span>新充值用户：<em>无字段……</em>人</span>
        <span>新消费用户：<em>无字段……</em>人</span>
        <span>新认证用户：<em>无字段……</em>人</span>
        <span>新主播用户：<em>无字段……</em>人</span>
    </div>
    <s-table
      ref="table"
      size="default"
