  ...
  <a-spin :spinning="confirmLoading">
    <a-form :form="form">
        ...
        <!-- <a-col :span="12">
          <a-form-item label="排序">
            <a-input-number
              ...
              v-decorator="['sort', {rules: [{required: false,  message: '请输入数字'}],initialValue: 0}]"
            />
          </a-form-item>
        </a-col> -->
        <a-col :span="12">
      ...
      <a-row :gutter="64">
        ...
        <!-- <a-col :span="12">
          <a-form-item label="小组选择">

             <a-input-search placeholder="input search text"  enter-button @search="groupSearchVisible=!groupSearchVisible" />
    <br />
          </a-form-item>
        </a-col> -->
      </a-row>
...
import { save, getById, update } from "@/api/discuss";
  ...
  methods: {
    ...
    edit(record) {
      ...
      getById({ pk: record.id }).then((response) => {
        ...
        setTimeout(() => {
          this.form.setFieldsValue(pick(result, "id", "title", "endtime"));
          if (result.imgurl) {
            this.fileList = [
              {
                uid: result.id,
