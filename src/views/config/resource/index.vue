        ...
        <a-row :gutter="48">
          <a-col :md="6" :sm="24">
            <a-form-item label="资源名称">
              <a-input v-model="queryParam.dto.fileName" placeholder="" />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="24">
            <a-form-item label="创建人">
              <a-input v-model="queryParam.dto.createName" placeholder="" />
            </a-form-item>
          </a-col>
          <a-col :md="6" :sm="24">
            <span
      ...
      <a-col :md="6" :sm="24" v-for="(data, index) in datas" :key="index">
        <a-card hoverable>
          ...
          <a-card-meta
            ...
            :description="
              '大小:' +
              conver(data.fileSize) +
              ' 日期:' +
              converDate(data.gmtCreate)
            "
          >
            <!-- <a-avatar
            slot="avatar"
...
import { page, deleteFile } from "@/api/resource";
