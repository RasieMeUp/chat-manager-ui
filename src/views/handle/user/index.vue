  ...
  <a-card :bordered="false">
    <div class="table-page-search-wrapper">
      <a-form layout="inline">
        <a-row :gutter="48">
          <a-col :md="4" :sm="24">
            <a-form-item label="处理人名称">
              <a-input v-model="queryParam.dto.handleName" placeholder="" />
            </a-form-item>
          </a-col>
          <a-col :md="20" :sm="24">
            <span
...
import { page, delByPk, down } from "@/api/system/handle";
...
export default {
  ...
  methods: {
    ...
    handleAddOrEdit(__type, record) {
      ...
      this.drawer01.title = __type == 0 ? "新增处理人" : "编辑处理人";
      this.$nextTick(() => {
        if (__type == 1) this.$refs.formHandle.edit(record);
        else this.$refs.formHandle.add();
      });
    },
    handleOk() {
