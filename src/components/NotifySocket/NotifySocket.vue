...
<div style="position:absolute;right:0px;bottom:0px">
  ...
  <a-modal title="静态化结果通知" style="top: 220px;" :visible="visible" @ok="confirm" @cancel="cancel">
    <a-progress :percent="percent" status="active" />
    <div style="max-height: 200px;overflow-y: auto;overflow-x: hidden;" ref="box" id="box">
